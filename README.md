...
🎯 Objectives<br>
- Implement an unsupervised learning approach using K-Means clustering
- Determine the optimal number of clusters using the Elbow Method
- Group students into meaningful clusters based on academic-related features
...
- Performed data scaling to ensure fair distance-based clustering

Elbow Method Analysis<br>
- Calculated Within-Cluster Sum of Squares (WCSS)
- Plotted the Elbow curve to identify the optimal value of K
- Selected the most suitable number of clusters based on the Elbow point

K-Means Clustering<br>
- Applied K-Means algorithm using the selected number of clusters
- Assigned cluster labels to each student record
